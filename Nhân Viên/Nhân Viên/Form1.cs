...
namespace Nhân_Viên
{
    public partial class Form1 : Form
    {
        ...
        private void bt2_Click(object sender, EventArgs e)
        {
            ...
            else if (txt1.Text == "" || txt2.Text == "" || txt3.Text == "" || cbb1.Text == "" || txtNgaySinh.Text == "" || txt4.Text == "" || txt5.Text == "" || txt6.Text == "" || txt7.Text == "" || txt8.Text == "" || txt9.Text == "" || txt10.Text == "")
            {
            ...
            {
                string sql = "Insert into Nhan_Vien values('" + txt1.Text + "', N'" + txt2.Text + "', N'" + txt3.Text + "', N'" + cbb1.Text + "', N'" + txtNgaySinh.Text + "', N'" + txt4.Text + "', N'" + txt5.Text + "', N'" + txt6.Text + "', N'" + txt7.Text + "', N'" + txt8.Text + "', N'" + txt9.Text + "', N'" + txt10.Text + "')";
        ...
        private void bt4_Click(object sender, EventArgs e)
        {
            ...
            {
                if (txt1.Text == "" || txt2.Text == "" || txt3.Text == "" || cbb1.Text == "" || txtNgaySinh.Text == "" || txt4.Text == "" || txt5.Text == "" || txt6.Text == "" || txt7.Text == "" || txt8.Text == "" || txt9.Text == "" || txt10.Text == "")
                {
                ...
                else
                {
                    data.Close();
                    data.Dispose();
                    string sql = "update Nhan_Vien set HoNV=@HoNV,TenNV=@TenNV,GioiTinh=@GioiTinh,NgaySinh=@NgaySinh,QueQuan=@QueQuan,DiaChi=@DiaChi,CMND=@CMND,SDT=@SDT,MaCV=@MaCV,password=@password,MaLuong=@MaLuong where MaNV=@MaNV";
        ...
        private void bt3_Click(object sender, EventArgs e)
        {
            if (txt1.Text == "" && txt6.Text == "")
            {
                MessageBox.Show("Vui lòng nhập mã nhân viên hoặc CMND nhân viên cần xóa ", "Thông Báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
            ...
            else
            {
                ...
                else
                {
                    ...
                    Disconnect();
                        ...
                        Connect();
                        SqlCommand Delete = new SqlCommand("delete  from Nhan_Vien WHERE MaNV = '" + txt1.Text + "' or CMND='" + txt6.Text + "'", sqlCon);
