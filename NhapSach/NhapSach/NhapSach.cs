...
namespace NhapSach
{
    public partial class NhapSach : Form
    {
        ...
        {
            //txtMaPhieuNhap.Text = dataGridView2.CurrentRow.Cells[0].Value.ToString();
            //txtNgayNhap.Text = dataGridView2.CurrentRow.Cells[1].Value.ToString();
            //txtMaNCC.Text = dataGridView2.CurrentRow.Cells[2].Value.ToString();
...
//            txtThue.Text = dataGridView2.CurrentRow.Cells[7].Value.ToString();
        }
